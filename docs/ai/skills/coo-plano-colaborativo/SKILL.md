...
- Em `planningAgreement`, cite para prioridade, responsabilidade, prazo, capacidade e recursos um ID de mensagem USER e um trecho literal que sustente cada acordo. Uma resposta vaga ou o clique de aprovação de uma etapa preparatória não confirma estes cinco pontos. Se custo for desconhecido, combine explicitamente quem e quando fará a estimativa; no 5W2H marque "a estimar".
